...
/*
  ...
  myGroceryList, and the second is an item to remove from myGroceryList. 
  If the second argument (or the item to add or remove) matches an item in 
  myGroceryList, remove that item from the your grocery list and return the new, 
  ...
  In addItem add the item you passed in to myGroceryList then return the new, 
  updated grocery list.

  In both removeItem and addItem check to see if the 'myGroceryList' and 'item' arguments
  are truthy.
...
/*
  Now let's say Cahlan has a mental breakdown and has to take a leave of absence to 
  'find himself'.
...
let user2 = {
  name: 'George Irving',
  email: 'geoman@email.com',
  password:'geonomatterwhat',
  username:'g0_irving'
}

let user3 = {
  name: 'Pete Wallace',
  email: 'pwalls@email.com',
  password:'g00fy31',
  username:'pwallace31'
}
